...
import tech.zxuuu.client.shop.CartPane;
...
public class ShopFirstPage extends JFrame {
	...
	tech.zxuuu.client.shop.CartPane cartPanel;
	...
	public void handleTypeButtonClick(JButton btn) {
		...
		if (list == null) {
			...
			for (int i = 0; i < list.size(); i++) {
				JPanel paneli = new tech.zxuuu.client.shop.Blocks(list.get(i).getPicture(), list.get(i).getInformation(), list.get(i).getName(),list.get(i).getType(),
						list.get(i).getPrice());
