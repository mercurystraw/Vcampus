package src.tech.zxuuu.client.teaching.studentSide;
...
import tech.zxuuu.client.teaching.studentSide.ClassSelectPane;
import tech.zxuuu.client.teaching.studentSide.QueryScorePane;
import tech.zxuuu.client.teaching.studentSide.ScheduleTablePane;
...
public class TeachingStudentMain extends JFrame {
	...
	private tech.zxuuu.client.teaching.studentSide.ScheduleTablePane scheduleTablePane;
...
//				currentDisplay = scheduleTablePane;
				...
				scheduleTablePane = new tech.zxuuu.client.teaching.studentSide.ScheduleTablePane();
				scheduleTablePane.setVisible(true);
