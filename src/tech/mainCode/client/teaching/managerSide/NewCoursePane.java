...
public class NewCoursePane extends JPanel {
	...
	public boolean judgeConflict(String time[]) {
		List<ClassInfo> Tca = ResponseUtils.getResponseByHash(
				new Request(App.connectionToServer, null, "tech.mainCode.server.teaching.ClassSelectGUI.getClassOfOneTeacher",
				...
				if (judgeConflict(time)) {
					...
					Boolean oci = ResponseUtils
							.getResponseByHash(new Request(App.connectionToServer, null,
									"tech.mainCode.server.teaching.CourseManagerSide.insertNewCourse", new Object[] { cla, idInAca }).send())
		...
		btnAutoLoad.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				String teacherName = ResponseUtils.getResponseByHash(
						new Request(App.connectionToServer, null, "tech.mainCode.server.teaching.CourseManagerSide.getTeacherNameById",
