...
public class ScheduleTablePane extends JPanel {
	...
	public List<ClassInfo> getClassOfOneTeacher(String card) {
		return ResponseUtils
				.getResponseByHash(new Request(App.connectionToServer, null,
						"tech.mainCode.server.teaching.ClassSelectGUI.getClassOfOneTeacher", new Object[] { card }).send())
	...
	public String getClassSeletion(Student student) {
		return ResponseUtils
				.getResponseByHash(new Request(App.connectionToServer, null,
						"tech.mainCode.server.teaching.ClassSelectGUI.getClassSelection", new Object[] { student }).send())
