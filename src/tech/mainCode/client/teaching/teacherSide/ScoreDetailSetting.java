package tech.mainCode.client.teaching.teacherSide;
...
public class ScoreDetailSetting extends JFrame {
	...
	public String getStudentNameByCardNumber(String card) {
		return ResponseUtils
				.getResponseByHash(new Request(App.connectionToServer, null,
						"tech.mainCode.server.studentManage.StudentManage.getNameByCardNumber", new Object[] { card }).send())
	...
	public String getStudentOfOneClass(String classId) {
		return ResponseUtils
				.getResponseByHash(new Request(App.connectionToServer, null,
						"tech.mainCode.server.teaching.Addons.getStudentOfOneClass", new Object[] { classId }).send())
				.getReturn(String.class);
	}
	...
	public Boolean updateScoreOfOneClass(String classId, String fullReturn) {
		return ResponseUtils
				.getResponseByHash(new Request(App.connectionToServer, null,
						"tech.mainCode.server.teaching.Addons.updateScoreOfOneClass", new Object[] { fullReturn }).send())
		...
		btnSave.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				Boolean result = ResponseUtils.getResponseByHash(new Request(App.connectionToServer, null,
						"tech.mainCode.server.teaching.Addons.updateScoreOfOneClass", new Object[] { classId, sb.toString() }).send())
						.getReturn(Boolean.class);
				if (result) {
