	...
	public DeleteProductPane() {
				...
				if (e.getClickCount() == 2) {
					...
					Boolean result = ResponseUtils
							.getResponseByHash((new Request(App.connectionToServer, null,
									"tech.mainCode.server.shop.Addons.deleteProduct", new Object[] { product }).send()))
		...
		btn_Search.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				list = ResponseUtils
						.getResponseByHash(new Request(App.connectionToServer, null,
								"tech.mainCode.server.shop.ProductServer.manageListProduct", new Object[] { product }).send())
