	...
	public void handleTypeButtonClick(JButton btn) {
		...
		List<Product> list = ResponseUtils
				.getResponseByHash(new Request(App.connectionToServer, null,
						"tech.mainCode.server.shop.ProductServer.listProductByType", new Object[] { btn.getText()}).send())
	...
	public ShopFirstPage() {
		...
		btn_Search.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				List<Product> list = ResponseUtils
						.getResponseByHash(new Request(App.connectionToServer, null,
								"tech.mainCode.server.shop.ProductServer.searchProduct", new Object[] { txt_Search.getText() }).send())
						.getListReturn(Product.class);
				if (list == null) {
					SwingUtils.showMessage(null, "抱歉，没有搜到这个商品，管理员正在努力备货中...", "提示");
				} else {
