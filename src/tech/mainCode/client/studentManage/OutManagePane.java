package tech.mainCode.client.studentManage;
		...
		buttonYes.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				String studentName = ResponseUtils.getResponseByHash(new Request(App.connectionToServer, null,
						"tech.mainCode.server.studentManage.StudentManage.getNameByCardNumber", new Object[] { cardnumber }).send())
				...
				Response resp = ResponseUtils.getResponseByHash(new Request(App.connectionToServer, null,
						"tech.mainCode.server.studentManage.StudentManage.deleteStudent", new Object[] { cardnumber }).send());
